...
#### A look back at 2017 with the stats to prove it
...
*   Started my new role as a [cloud developer advocate](https://blog.jeremylikness.com/what-is-a-cloud-developer-advocate-f7606b5a9a08) at Microsoft
...
[Reflecting on 15 Years of Blogging](https://blog.jeremylikness.com/reflecting-on-15-years-of-blogging-dc008ee71053)
...
*   [Twitter in Review](#ea30)
*   [Legacy (C#er: Image) Blog in Review](#59d0)
*   [Developer for Life in Review](#bb26)
*   [Links and Click Data](#3f10)### Twitter in Review
...
For the “signal-to-noise ratio” I currently review anywhere between 500–1500 items daily to curate what I believe are the top 5–10 noteworthy items to share with my followers. This is in addition to content I author myself. See the [links and click data](#3f10) section to learn more.
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/1.png)
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/2.png)

C#er: IMage sessions in 2017
...
C#er: IMage visitor sources in 2017
...
[Create a Serverless Angular App with Azure Functions and Blob Storage](https://blog.jeremylikness.com/create-a-serverless-angular-app-with-azure-functions-and-blob-storage-20164c083c88)


Based on these statistics, I’m seriously considering writing an updated version of the MVVM article that tackles modern JavaScript frameworks and redirects from the old blog. Only time will tell if I end up doing that in 2018 — we’ll call it a “stretch goal.”### Developer for Life in Review
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/4.png)

Developer for Life sessions in 2017
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/5.png)

Developer for Life visitor sources in 2017
...
2.  Twitter
3.  [Reddit](https://www.reddit.com/) thanks mainly to a post in [/r/programming](https://www.reddit.com/r/programming/) about my blog post “[.NET Core 2.0 is Ready and Sterling Proves It!](https://www.reddit.com/r/programming/comments/6vvogu/net_core_20_is_ready_and_sterling_proves_it/)”
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/6.png)

Developer for Life top viewed pages (Google Analytics) in 2017
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/7.png)

Top pages in 2017 per Medium
...
Using data I started collecting in September, just shortly after launching my new blog, I was able to track engagement to not just my own content, but other sites as well. I regularly publish content to my [Twitter] (https://twitter.com/JeremyLikness)and [LinkedIn](https://linkedin.com/in/JeremyLikness) profiles along with my [Facebook page](http://facebook.com/cdaJeremyLikness). I used to leverage Google+ but phased that out due to lack of engagement: despite thousands of followers I only had one or two users click through content.
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/8.png)

Redirects by source in 2017
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/9.png)

Redirects by source in December 2017
...
1.  [Exploring the CosmosDB with Power BI](https://blog.jeremylikness.com/exploring-cosmosdb-with-powerbi-9192317087d8)
2.  [Five REST Web API Designs in .NET Core Part 4: Optimistic Concurrency](https://blog.jeremylikness.com/5-rest-api-designs-in-dot-net-core-4-8ac863e961e4)
3.  [Documentation for Azure Kubernetes Services (AKS)](https://docs.microsoft.com/azure/aks/)
4.  [Expanding Azure Functions to the CosmosDB](https://blog.jeremylikness.com/expanding-azure-functions-to-the-cosmos-423d0cb920a)
...
Thanks for taking the time to read these insights. As always I’d love to hear your feedback. Feel free to leave a comment on this blog or [Direct Message me](https://twitter.com/messages/compose?recipient_id=jeremylikness) on Twitter!
...
![image](/blog/2017-12-27_year-of-docker-serverless-and-.net-core-2017-in-review/images/10.gif)
